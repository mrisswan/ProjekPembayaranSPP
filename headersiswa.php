    ...
    <div class="container">
      <div class="row">
        <div class="col-12">
          <nav class="main-nav">
            <!-- ***** Logo Start ***** -->
            <a href="index_siswa.php" class="logo">
              <img src="cssF/assets/images/logo-v1.png" alt="">
            </a>
            <!-- ***** Logo End ***** -->
            <!-- ***** Menu Start ***** -->
            <ul class="nav">
                    <li class="scroll-to-section"><a href="biodata.php">Biodata</a></li>
                    <li class="scroll-to-section"><a href="historysiswa.php">History Pembayaran</a></li>
